# -*- coding: utf-8 -*-
"""
Implied volatility surfaces for Rough Heston and classical Heston.

This script does not recalibrate either model. It reads the final global
parameters produced in the global calibration section and reconstructs smooth
Rough Heston and classical Heston implied volatility surfaces on a common
(K/F0(T), T) grid.

Both models use the COS pricing engine and the same Black-Scholes inversion to
maintain a comparable numerical framework.
"""
...
OUT_RH_CSV = CSV_DIR / "01_rough_heston_implied_volatility_surface.csv"
OUT_H_CSV = CSV_DIR / "02_heston_implied_volatility_surface.csv"

OUT_RH_FIG = FIGURES_DIR / "01_rough_heston_implied_volatility_surface.png"
OUT_H_FIG = FIGURES_DIR / "02_heston_implied_volatility_surface.png"
...
# =============================================
# 3. ROBUST READING OF CALIBRATED PARAMETERS
# =============================================
...
print("\n" + "=" * 76)
print("GLOBAL PARAMETERS READ FROM 03_GLOBAL_CALIBRATION")
print("=" * 76)
...
# Domain deliberately centered on the most economically readable region.
...
# =====================================================
# 8. CONVERTING MODEL PRICES TO IMPLIED VOLATILITIES
# =====================================================
...
IV_H, H_TABLE = model_surface("Classical Heston")
...
def print_diagnostic(name, surface):
    ...
    print("\n" + name)
    print("-" * len(name))
    print(f"Valid IV: {n_valid}/{n_total}")
...
if len(all_valid) == 0:
    raise ValueError(
        "No valid implied volatility across the two surfaces."
    )
...
save_surface(
    IV_H,
    "Classical Heston implied volatility surface",
    OUT_H_FIG,
)
