"""Short-term calibration of the classical Heston model on the SPX option sample.

The script uses maturities up to 31 days and a multistart TRF calibration,
with COS pricing and Black-Scholes implied-volatility inversion.
"""
...
# to make the numerical comparison as homogeneous as possible.
N_cos = 128
L = 10.0
...
# the COS method, also used for Rough Heston.
...
# ===============================================================
# 8. BLACK-SCHOLES CALL / PUT WITH CONTINUOUS DIVIDEND YIELD q
# ===============================================================
...
# ==============================================
# 11. MARKET IMPLIED VOLATILITIES AND METRICS
# ==============================================
...
# ===============================================================
# 13. SHORT-TERM CLASSICAL HESTON CALIBRATION - MULTISTART TRF
# ===============================================================
...
print()
print("============================================================")
print("SHORT-TERM CLASSICAL HESTON CALIBRATION")
print("============================================================")
print()
...
print("============================================================")
print()
print(f"Number of valid IVs = {MET_H['N']}")
print(f"RMSE IV             = {RMSE:.8f}")
print(f"MAE IV              = {MAE:.8f}")
print(f"Maximum IV error    = {MAX_ERROR:.8f}")
...
for name, value, lower, upper in zip(
    ...
    print(
        ...
        f" | distance to upper bound = {upper - value:.8f}"
    )
...
market_model_figure_path = (
    FIGURES_DIR
    / "04_market_vs_heston_short_term_calibration.png"
)
...
maturity_figure_path = (
    FIGURES_DIR
    / "05_residuals_by_maturity_heston_short_term_calibration.png"
)
...
moneyness_figure_path = (
    FIGURES_DIR
    / "06_residuals_by_forward_moneyness_heston_short_term_calibration.png"
)
...
multistart_path = (
    CSV_DIR
    / "05_heston_short_term_multistart_results.csv"
)
