"""
Global Rough Heston calibration on SPX options.

This script calibrates the Rough Heston model to the final SPX calibration
sample using the Trust Region Reflective (TRF) least-squares algorithm. Option
prices are computed with the COS method and converted into implied volatilities
to evaluate the fit across maturities and forward moneyness.
"""
    ...
    for T, group in df.groupby("T"):
        ...
        try:
            ...
            for K, option_type, call_price in zip(
                ...
                # Correction of very small negative values
...
# =================================
# 19. DISPLAY BEFORE CALIBRATION
# =================================

print()
print("=============================")
print("CALIBRATION ROUGH HESTON")
print("=============================")
print()
...
market_model_figure_path = (
    FIGURES_DIR
    / "01_market_vs_rough_heston_global_calibration.png"
)
...
maturity_figure_path = (
    FIGURES_DIR
    / "02_residuals_by_maturity_global_calibration.png"
)
...
moneyness_figure_path = (
    FIGURES_DIR
    / "03_residuals_by_forward_moneyness_global_calibration.png"
)
